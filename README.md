...
- Booking updates `bookings` and sets `available = false` for rooms.
- Cancellations revert availability status to true.
...
- Role: System Administrator for database maintenance
